...
__attribute__((swift_name("IDiscoverHandle")))
@protocol HbpIDiscoverHandle
@required
- (BOOL)cancel __attribute__((swift_name("cancel()")));
@end

__attribute__((swift_name("IHbpSdkBase")))
@protocol HbpIHbpSdkBase
@required
- (id<HbpIDiscoverHandle>)discoverByBikeIdBikeId:(NSString *)bikeId withTimeoutInMillis:(int64_t)withTimeoutInMillis hyDeviceFound:(void (^ _Nullable)(NSString * _Nullable))hyDeviceFound cb:(void (^)(id<HbpIHyenaDrive> _Nullable, HbpKotlinException * _Nullable))cb __attribute__((swift_name("discoverByBikeId(bikeId:withTimeoutInMillis:hyDeviceFound:cb:)")));
- (id<HbpIDiscoverHandle>)discoverByPeripheralIdPeripheralId:(NSString *)peripheralId withTimeoutInMillis:(int64_t)withTimeoutInMillis hyDeviceFound:(void (^ _Nullable)(NSString * _Nullable))hyDeviceFound cb:(void (^)(id<HbpIHyenaDrive> _Nullable, HbpKotlinException * _Nullable))cb __attribute__((swift_name("discoverByPeripheralId(peripheralId:withTimeoutInMillis:hyDeviceFound:cb:)")));
- (id<HbpIDiscoverHandle>)discoverByWelcomeWithTimeoutInMillis:(int64_t)withTimeoutInMillis hyDeviceFound:(void (^ _Nullable)(NSString * _Nullable))hyDeviceFound cb:(void (^)(id<HbpIHyenaDrive> _Nullable, HbpKotlinException * _Nullable))cb __attribute__((swift_name("discoverByWelcome(withTimeoutInMillis:hyDeviceFound:cb:)")));
...
- (void)scanAllCb:(void (^)(id<HbpIHyenaDrive> _Nullable, HbpKotlinException * _Nullable))cb __attribute__((swift_name("scanAll(cb:)")));
- (void)scanDfuCb:(void (^)(id<HbpIHyenaDrive> _Nullable, HbpKotlinException * _Nullable))cb __attribute__((swift_name("scanDfu(cb:)")));
...
@property (readonly) BOOL isHMIInDfuMode __attribute__((swift_name("isHMIInDfuMode")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NotFoundException")))
@interface HbpNotFoundException : HbpKotlinException
...
- (void)partsMockSetting_partsMockSetting:(id<HbpIPartsMockSetting>)_partsMockSetting __attribute__((swift_name("partsMockSetting(_partsMockSetting:)")));
...
__attribute__((swift_name("IPartsMockSetting")))
@protocol HbpIPartsMockSetting
@required
@property NSString * _Nullable controllerFWVersion __attribute__((swift_name("controllerFWVersion")));
@property NSString * _Nullable hmiFWVersion __attribute__((swift_name("hmiFWVersion")));
@property NSString * _Nullable hmiFontVersion __attribute__((swift_name("hmiFontVersion")));
@property NSString * _Nullable hmiIconVersion __attribute__((swift_name("hmiIconVersion")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IPartsMockSettingKt")))
@interface HbpIPartsMockSettingKt : HbpBase
+ (BOOL)allMockVersionsValid:(id<HbpIPartsMockSetting>)receiver __attribute__((swift_name("allMockVersionsValid(_:)")));
@end
